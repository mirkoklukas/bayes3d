...
# %% auto 0
__all__ = ['PI', 'TWOPI', 'CAM_ALONG_X', 'Rot', 'Pose', 'Control', 'ax_to_ind', 'Rotation', 'rot_x', 'rot_y', 'rot_z',
           'from_euler', 'look_at', 'unpack_pose', 'pack_pose', 'apply_pose', 'mpl_plot_pose', 'lift_pose']
...
# %% ../../scripts/notebooks/_mkl/01 - Pose.ipynb 9
Pose    = namedtuple("Pose", ["x", "r"])
Control = namedtuple("Pose", ["dx", "dr"])
...
# %% ../../scripts/notebooks/_mkl/01 - Pose.ipynb 10
